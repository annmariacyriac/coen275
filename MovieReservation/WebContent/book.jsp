...
List<String> selectedSeats =(List<String>) request.getSession().getAttribute("selectedSeats");
	...
	%>
      ...
      <p>Movie<span class="price"><%=(String) session.getAttribute("movieName") %></span></p>
      <p>Theatre<span class="price"><%=(String) session.getAttribute("theatreName") %></span></p>
      <p>Screen<span class="price"><%=((Show) session.getAttribute("showDetails")).getScreen().getScreenName()%></span></p>
      <p>Showdate<span class="price"><%=((Show) session.getAttribute("showDetails")).getShowDate()%></span></p>
      <p>Time<span class="price"><%=((Show) session.getAttribute("showDetails")).getShowTime() %></span></p>
      <p>Seats<span class="price"><%for (String selectedSeat : selectedSeats) {%>
			<%=selectedSeat%>
		<%}%></span></p>   
      <hr>
